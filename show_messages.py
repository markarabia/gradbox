...
message_font_path = "static/fonts/Quicksand.ttf"

if not os.path.exists(name_font_path):
    name_font_path = None
if not os.path.exists(message_font_path):
    message_font_path = None

font_large = ImageFont.truetype(name_font_path, 28) if name_font_path else ImageFont.load_default()
font_medium = ImageFont.truetype(name_font_path, 26) if name_font_path else ImageFont.load_default()
font_small = ImageFont.truetype(message_font_path, 20) if message_font_path else ImageFont.load_default()
